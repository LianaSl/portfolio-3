export function Hlavni() {
  ...
  <aside class="aside">
        <div class="parent">
            <div class="foto">
                <a href="#"><img class="logo-img2" src="/liana.jpg" alt="foto" fetchpriority="high"></a>
            </div>
            <p>Dobrý den, jmenuji se Liana.
            ...
            <div class="foto2">
                <a href="#"><img class="karLi" src="/karLi.jpg" alt="logo" fetchpriority="high"></a>
            </div>
        </div>
    </aside>
